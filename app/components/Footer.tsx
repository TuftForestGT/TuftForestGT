...
export default function Footer() {
  return (
    <footer className="bg-forest-950 border-t border-forest-800 text-forest-400 py-10">
      <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <div className="text-xs">Alfombras artesanales · Guatemala</div>
          </div>
        </div>

        <div className="text-center text-sm">
          <p>Hecho con 🌿 en Guatemala</p>
          <p className="text-xs mt-1">© {new Date().getFullYear()} TuftForest GT. Todos los derechos reservados.</p>
        </div>
